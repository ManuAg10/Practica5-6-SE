...
io_ctrl/src/%.o: ../io_ctrl/src/%.c
	...
	sparc-rtems-gcc -I"/home/atcsol/workspace/prac6_students/rtems_osswr/include" -I"/home/atcsol/workspace/prac6_students/leon3_bprint/include" -I"/home/atcsol/workspace/prac6_students/bprint_swr/include" -I"/home/atcsol/workspace/prac6_students/edroomsl_types_swr/include" -O0 -g3 -Wall -msoft-float -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
