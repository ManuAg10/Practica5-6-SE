...
//User Task declarations (las añado yo, una por cada task de abajo)
...
//Declaración del identificador del identificador del Mutex y el nombre como variable global (nuevo)
rtems_id MutexId;
