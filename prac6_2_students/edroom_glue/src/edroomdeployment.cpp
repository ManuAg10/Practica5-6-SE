...
TEDROOMSignal CEDROOMSystemCommSAP::C4AvoidObstaclesIRQ_PAvoidObstaclesSysCtrl__C1MainActor_PAvoidObstaclesSysCtrl(TEDROOMSignal signalOut){
 
	TEDROOMSignal signalIn;
 
	switch(signalOut){
 
		case( CCAvoidObstaclesIRQ::SObstacleDetected):	 signalIn=Vehicle::SObstacleDetected; break;
 
		case( CCAvoidObstaclesIRQ::SConfigError):	 signalIn=Vehicle::SConfigError; break;
 
		case( CCAvoidObstaclesIRQ::SConfigOK):	 signalIn=Vehicle::SConfigOK; break;
...
TEDROOMSignal CEDROOMSystemCommSAP::C1MainActor_PAvoidObstaclesSysCtrl__C4AvoidObstaclesIRQ_PAvoidObstaclesSysCtrl(TEDROOMSignal signalOut){
 
	TEDROOMSignal signalIn;
 
	switch(signalOut){
 
		case( Vehicle::SConfigAO):	 signalIn=CCAvoidObstaclesIRQ::SConfigAO; break;
 
		case( Vehicle::SStart):	 signalIn=CCAvoidObstaclesIRQ::SStart; break;
...
void CEDROOMSystemCommSAP::RegisterInterfaces(){
	...
	m_localCommSAP.RegisterInterface(2, mp_comp4->SensorIRQ, mp_comp4);
...
void CEDROOMSystemCommSAP::SetLocalConnections(){
	...
	m_localCommSAP.Connect(mp_comp4->AvoidObstaclesSysCtrl, mp_comp1->AvoidObstaclesSysCtrl, connections[0], 
					C4AvoidObstaclesIRQ_PAvoidObstaclesSysCtrl__C1MainActor_PAvoidObstaclesSysCtrl, 
					C1MainActor_PAvoidObstaclesSysCtrl__C4AvoidObstaclesIRQ_PAvoidObstaclesSysCtrl);
